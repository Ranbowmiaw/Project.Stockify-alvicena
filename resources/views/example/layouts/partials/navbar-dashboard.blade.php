      ...
      <div class="flex items-center">
            ...
            <div>
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="w-full pl-3">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400">New message from <span class="font-semibold text-gray-900 dark:text-white">Baros</span>: "Hey, Rencananya mau bikin bomb antom versi big boy 💀"</div>
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="w-full pl-3">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Hitler</span> and <span class="font-medium text-gray-900 dark:text-white">5 others</span> started following you.</div>
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="w-full pl-3">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Mamak</span> and <span class="font-medium text-gray-900 dark:text-white">525k others</span> love your story. See it and view more stories.</div>
              ...
              <a href="#" class="flex px-4 py-3 border-b hover:bg-gray-100 dark:hover:bg-gray-600 dark:border-gray-600">
                ...
                <div class="w-full pl-3">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Nojo</span> mentioned you in a comment: <span class="font-medium text-primary-700 dark:text-primary-500">@Baros</span> Woy bangun dongo, tadi kita mau mengerjakan apa?</div>
              ...
              <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-600">
                ...
                <div class="w-full pl-3">
                    <div class="text-gray-500 font-normal text-sm mb-1.5 dark:text-gray-400"><span class="font-semibold text-gray-900 dark:text-white">Diddy</span> posted a new video: Glassmorphism - learn how to use baby oil for fun.</div>
          ...
          <div class="z-20 z-50 hidden max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600" id="apps-dropdown">
            ...
            <div class="grid grid-cols-3 gap-4 p-4">
              ...
              <a href="{{ url('settings-role') }}" class="block p-4 text-center rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
          ...
          <div class="flex items-center ml-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button-2" aria-expanded="false" data-dropdown-toggle="dropdown-2">
                ...
                @if ($user && $user->profile_picture)
                  <img class="w-8 h-8 rounded-full" src="{{ asset('image/profiles/' . $user->profile_picture) }}" alt="Foto Profil">
                @else
                  <img class="w-8 h-8 rounded-full" src="{{ asset('image/profiles/default.jpeg') }}" alt="Foto Default">
                @endif
              </button>
            </div>
            <!-- Dropdown menu -->
            <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-2">
              ...
              <ul class="py-1" role="none">
                ...
                <li>  
                  <a href="{{ url('settings-role') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">Settings</a>
                </li>
                <li>
